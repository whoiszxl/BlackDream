...
contract EcommerceStore {
    ...
    function revealBid(uint _productId, string memory _amount, string memory _secret) public {
        ...
        require(now > product.auctionEndTime);
        //获取到加密后的key
        bytes32 sealedBid = keccak256(bytes(strConcat(_amount, _secret)));
    ...
    /**
     * 因为官方没有实现字符串拼接函数，故需自己实现
     * 参考链接：https://ethereum.stackexchange.com/questions/729/how-to-concatenate-strings-in-solidity
     */
